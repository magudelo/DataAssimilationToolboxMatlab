function [x,w,ind] = PFRS_multinom(x,w,N,~)
%PFRS_MULTINOM applies multinomial resampling.
%
%  - Input variable(s) -
...
%
%  - Construction -
% [X,W] = PFRS_MULTINOM(X,W) resamples all the states X and their associated 
% weights W using simple random sampling .
%
% [X,W] = PFRS_MULTINOM(X,W,N) returns a resampled distribution of size N.
%  
% References: 
