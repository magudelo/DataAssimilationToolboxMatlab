function [x,w,ind] = PFRS_stratisfied(x,w,N,~)
%PFRS_STRATISFIED applies stratisfied resampling.
%
%  - Input variable(s) -
...
%
%  - Construction -
% [X,W] = PFRS_STRATISFIED(X,W) resamples all the states X and their  
% associated weights W using stratisfied resampling .
%
% [X,W] = PFRS_STRATISFIED(X,W,N) returns a resampled distribution of 
% size N.
%  
% References: 
