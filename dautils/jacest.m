function [jac,err] = jacest(fun,deriv,x0,t,u,n0,Ts)
...
if strcmp(deriv,'x')
    nx = numel(x0);
elseif strcmp(deriv,'w') || strcmp(deriv,'v') 
    nx = numel(n0);
end
...
for i = 1:nx
	if strcmp(deriv,'x')
        ...
        fdel = zeros(n,nsteps);
        for j = 1:nsteps
            fdif = fun(swapelement(x0,i,x0_i + delta(j)),t,u,n0,Ts) - ...
            fun(swapelement(x0,i,x0_i - delta(j)),t,u,n0,Ts);
    ...
    elseif strcmp(deriv,'w')||strcmp(deriv,'v')
        ...
        fdel = zeros(n,nsteps);
        for j = 1:nsteps
            fdif = fun(x0,t,u,swapelement(n0,i,n0_i + delta(j)),Ts) - ...
            fun(x0,t,u,swapelement(n0,i,n0_i - delta(j)),Ts);
